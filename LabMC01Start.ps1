...
Switch-AzureMode AzureResourceManager
New-AzureResourceGroupDeployment -Name $deploymentname -ResourceGroupName $rgname -TemplateUri https://raw.githubusercontent.com/azure/azure-quickstart-templates/master/minecraft-on-ubuntu/azuredeploy.json
